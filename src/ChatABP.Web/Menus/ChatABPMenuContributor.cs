...
namespace ChatABP.Web.Menus
{
    public class ChatABPMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public ChatABPMenuContributor(IConfiguration configuration)
        {
        ...
        private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
        {
            ...
            var l = context.GetLocalizer<ChatABPResource>();

            context.Menu.Items.Insert(0, new ApplicationMenuItem(ChatABPMenus.Home, l["Menu:Home"], "~/"));
